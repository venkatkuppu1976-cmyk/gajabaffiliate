  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-[#4A4A4A] mt-1">Every order that used a referral code, with full breakdown.</p>
      </div>
            ...
            <tbody>
              {referralUtilization.map((u, i) => (
                <tr key={i} className="border-b border-[#EAE6E1] hover:bg-[#FFF6DC]" data-testid={`util-row-${u.orderId}`}>
                  ...
                  <td className="p-3 text-right text-[#E11D2A] font-bold">- ₹{u.discount}</td>
