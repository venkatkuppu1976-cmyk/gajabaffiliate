  ...
  return (
    <div className="space-y-5">
      ...
      <div className="gajab-card p-5 space-y-3">
        <h3 className="font-display text-lg flex items-center gap-2"><Globe className="w-5 h-5 text-[#F26B1F]" /> Preferences</h3>
      ...
      <div className="gajab-card p-5 space-y-3">
        ...
        <button className="btn-ghost w-full justify-start" onClick={()=>toast.success("2FA enabled")}>Enable two-factor auth</button>
